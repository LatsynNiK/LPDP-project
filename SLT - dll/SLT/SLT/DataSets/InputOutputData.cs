...
namespace SLT.DataSets
{
    ...
    public class InputOutputData
    {
        ...
        //protected SLT.Structure.Model Model;
        ...
        //public void SetParentModel(SLT.Structure.Model model)
        //{
        //    this.Model = model;
    ...
    //        {
    //            foreach (SLT.Objects.Object obj in GVT.Vars[unit])
    //            {
    //                if (unit == obj.Unit)
    //                {
    ...
    //                    switch (obj.Type)
    //                    {
    //                        case SLT.Objects.ObjectType.Scalar:
    //                            type = "Скаляр";
    //                            break;
    //                        case SLT.Objects.ObjectType.Link:
    //                            type = "Ссылка";
    //                            break;
    //                        case SLT.Objects.ObjectType.Vector:
    //                            type = "Вектор";
    //                            break;
    //                        case SLT.Objects.ObjectType.Macro:
    //                            type = "Макрос";
    //                            break;
    //                    }

    //                    if (obj.Type == SLT.Objects.ObjectType.Vector)
    //                    {
    //                        value = ((SLT.Objects.Vector)obj).GetTree();
    //                    }
    //                    Objects.Rows.Add(obj.Unit, obj.Name, value, type);
    //                    if (obj.Type == SLT.Objects.ObjectType.Vector)
    //                    {
    //                        SLT.Objects.Vector Vec = (SLT.Objects.Vector)obj;
    //                        SLT.Objects.Vector SubVector = (SLT.Objects.Vector)Vec;
    //                        List<SLT.Objects.Object> vector_value = (List<SLT.Objects.Object>)(SubVector.GetValue());
    ...
    //            SLT.Objects.Object obj = this.Model.O_Cont.GetObjectFromInitiator(init);
    //            name = obj.Name;
    //            object value_obj = obj.GetValue();
    //            try
    //            {
    ...
    //    void Write_Vector_to_DataTable(DataTable DT, List<SLT.Objects.Object> list)
    //    {
    //        foreach (SLT.Objects.Object obj in list)
    //        {
    //            string type = "";
    //            switch (obj.Type)
    //            {
    ...
    //            if (obj.Type == SLT.Objects.ObjectType.Vector)
    //            {
    //                SLT.Objects.Vector Subvec = (SLT.Objects.Vector)obj;
    //                DT.Rows.Add("", Subvec.Name, Subvec.GetTree(), type);
    //                this.Write_Vector_to_DataTable(DT,(List<SLT.Objects.Object>)Subvec.GetValue());
    //            }
    //            else
    //            {
    //                object value_obj = obj.GetValue();
